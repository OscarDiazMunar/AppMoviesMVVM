package com.oscar.appmoviesmvvm.presentation.ui.TabMovies;
...
public class TabMoviesActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    return ListMoviesFragment.newInstance(Constants.TYPE_FRAGMENT.POPULAR);
                case 1:
                    return ListMoviesFragment.newInstance(Constants.TYPE_FRAGMENT.TOP_RATED);
                case 2:
                    return ListMoviesFragment.newInstance(Constants.TYPE_FRAGMENT.UPCOMING);
            }
            return null;
        }
